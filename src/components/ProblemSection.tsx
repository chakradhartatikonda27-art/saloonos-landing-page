...
import { 
  XCircle, CheckCircle2, ArrowDown, MessageSquareX, Clock, Receipt, Users, UserX, EyeOff, Sparkles
} from 'lucide-react';
...
export const ProblemSection: React.FC = () => {
  const problems = [
    ...
    },
    {
      ...
      solution: 'Live digital token system computing exact waiting times based on floor chair progress and stylist availability.'
    },
    {
      icon: Receipt,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-950/60 border border-rose-500/30 text-rose-300 text-xs font-semibold">
            <span>THE OLD SALON CHAOS</span>
          </div>

          <h2 className="text-3xl sm:text-5xl font-heading font-extrabold text-white tracking-tight">
            Your Salon Shouldn’t Run on <br className="hidden sm:inline" />
            <span className="text-rose-400">WhatsApp, Spreadsheets & Memory.</span>
          </h2>

          <p className="text-base sm:text-lg text-slate-300">
            Running a modern salon with disconnected tools creates operational friction, lost revenue, and exhausted owners.
          </p>
        </div>
              ...
              >
                <div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="px-2.5 py-0.5 text-[10px] font-bold text-rose-400 bg-rose-500/10 border border-rose-500/20 rounded-full">
                      CHAOS
                    </span>
                  </div>
                ...
                <div className="mt-6 pt-4 border-t border-slate-800/80 bg-indigo-950/20 -mx-6 -mb-6 p-6">
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-gradient-to-r from-indigo-950 via-slate-900 to-purple-950 border border-indigo-500/40 shadow-xl shadow-indigo-950/50">

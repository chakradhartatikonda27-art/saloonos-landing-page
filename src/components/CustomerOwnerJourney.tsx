        ...
        <div className="mt-14 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="glass-card rounded-2xl p-6 md:p-8 border border-indigo-500/30 space-y-6">
            <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-white font-heading">The Customer Experience</h3>
                <div className="text-xs text-indigo-300">Frictionless visit from booking to rebooking</div>
              </div>
            </div>

            <div className="space-y-2.5">
              {customerSteps.map((step, i) => (
                <div key={i} className="flex items-center gap-3 p-2.5 rounded-lg bg-slate-900/80 border border-slate-800 text-xs text-slate-200">
          ...
          {/* Owner Journey */}
          <div className="glass-card rounded-2xl p-6 md:p-8 border border-purple-500/30 space-y-6 bg-purple-950/10">
            <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
              <div className="w-10 h-10 rounded-xl bg-purple-600/20 text-purple-300 flex items-center justify-center font-bold">
                <Building2 className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-white font-heading">The Salon Owner Experience</h3>
                <div className="text-xs text-purple-300">Total operational control without stress</div>
              </div>
            </div>
            ...
            <div className="space-y-2.5">
              {ownerSteps.map((step, i) => (
                <div key={i} className="flex items-center gap-3 p-2.5 rounded-lg bg-slate-900/80 border border-slate-800 text-xs text-slate-200">
                  <span className="w-5 h-5 rounded-full bg-purple-500/20 text-purple-300 font-bold text-[10px] flex items-center justify-center shrink-0">
                    {i + 1}
                  </span>
                  <span>{step}</span>
                </div>
